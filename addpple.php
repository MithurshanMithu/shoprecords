   ...
   <CENTER>
	...
	<table border="2" width="1200"> 
		...
		<tr>
			...
			<td class="tdbg"> Add Shop Name </td>
		...
		<tr>
		<td colspan="2"> </td>
		<th >	<input type="submit" class="button" style="vertical-align:middle" value="Add Customer">  </th>
			
		<th>	<input type="reset" class="button" style="vertical-align:middle" value="Reset" onclick="resett();"> </th>
